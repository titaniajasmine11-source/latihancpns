...
insert into app_settings (key, value) values
  ...
  ('practice', '{"default_question_count":10,"allowed_question_counts":[5,10,20],"low_stock_threshold":10,"exam_duration_minutes":100,"exam_category_targets":{"TWK":15,"TIU":15,"TKP":15}}'),
